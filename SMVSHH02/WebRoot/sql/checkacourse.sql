...
insert  into `t_course`(`id`,`coursename`,`courseclass`,`coursetime`,`coursebord`,`coursecount`,`coursesy`,`coursepeople`,`cotein`,`coursetype`,`type`,`courseteacherid`) values (1,'摄影技术','理学院','周三',1.5,130,25,105,'无','6',NULL,2),(2,'营养健康跟美容','园林与艺术学院','周三',1.5,120,19,101,'无','6',NULL,2),(3,'java','软件学院','周一',2,50,9,41,'无','2',NULL,NULL),(4,'javaweb','软件学院','周一',2,50,5,45,'无','2',NULL,NULL),(5,'足球','体育学院','周一',1.5,130,25,105,'无','1',NULL,NULL),(6,'篮球','体育学院','周一',1.5,80,12,68,'无','1',NULL,NULL),(7,'民俗体育与文化','体育学院','周五',1.5,90,81,9,'无','6',NULL,NULL),(8,'绘画与勘查','园林与艺术学院','周五',1.5,50,41,9,'有一定的绘画的基础','6',NULL,NULL),(9,'uml','软件学院','周二',1.5,50,0,50,'无','2',NULL,NULL),(16,'java','软件学院','周一',2,50,8,42,'无',NULL,'2',1);
...
insert  into `t_course_student`(`id`,`studentsid`,`courseid`) values (7,2,16);
